...
export default function Create_Invoice() {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        car_type: '',
        percent: '',
        service: [] as Array<{service: string, price: number}>,
    ...
    const submit = (e: any) => {
        ...
        // Calculate total price from services before submitting
        const calculatedPrice = data.service.reduce((sum, item) => sum + (item.price || 0), 0);
        
        // Update the data with calculated price before submission
        setData('price', calculatedPrice.toString());
    ...
    const basePrice = servicesSubtotal; // Price is now sum of services
            ...
            <div className="flex justify-between items-center mb-6 px-6 pt-6">
                <div>
                    ...
                    <p className="text-gray-600 mt-1 arabic-font">
                        {t('create-new-invoice-description') || 'Create a new invoice for your client'}
                    </p>
                </div>
                <Link
                    href='/show/invoices'
                ...
                <form onSubmit={submit} className="space-y-6">
                        ...
                        <Card className="lg:col-span-2">
                            <CardHeader>
                                ...
                                <CardDescription className="arabic-font">
                                    {t('client-info-description') || 'Search for existing client or enter new client details'}
                                </CardDescription>
                            </CardHeader>
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="grid gap-4 md:grid-cols-2">
                                <CustomInput
                                    ...
                                    type='number'
                                    placeholder={t('vat')}
                                    value={data.vat.toString()}
                                    onChange={(e: any) => setData('vat', Number(e.target.value))}
                                    error={errors.vat}
                                />
                            </div>
                                                        ...
                                                        {isSelected && (
                                                            <div className="mt-2">
                                                                <CustomInput
                                                                    ...
                                                                    value={(selectedService?.price || 0).toString()}
                    ...
                    <div className="flex justify-center pt-6">
                        ...
                        >
                            ...
                            {processing ? t('saving') : t('create-invoice')}
                        </Button>
                    </div>
                </form>
            </div>

            <Custommodal modalname={modalRef} message={t('invoice-added-successfully')} />
        </AppLayout>
    );
}
